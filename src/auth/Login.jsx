      ...
      <div className="mx-auto my-10 max-w-md rounded-xl border px-4 py-10 text-gray-700 shadow-lg sm:px-8">
        <div className="mb-16 flex justify-between">
          <span className="font-bold">
            <span className="inline-block  h-3 w-3 bg-blue-600"></span>Welcome Back!
          </span>
          <span className="">
            Have account?{" "}
            <Link
        ...
        <p className="mb-5 text-3xl font-medium">VITpat</p>
        <p className="mb-6 text-sm">
          "Plan - Learn - Revise": Planning and Tracking platform
        </p>
        <div className="mb-6">
